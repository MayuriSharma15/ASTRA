 ...
 * Resume
 * -----------------------------------------------------------------------
 * Real resume editor backed by MongoDB, plus real AI review via Gemini.
 * "Save" and "Get AI Review" are two separate, deliberate actions —
 * reviewing costs an API call, so it shouldn't fire automatically on
 * every keystroke or even every save; the user explicitly asks for it
...
export function Resume() {
  ...
  async function handleReview() {
    ...
    setError("");
    try {
      // Save first, so the review reflects the latest edits
